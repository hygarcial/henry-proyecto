...
$sql="INSERT INTO crudinmobiliaria.empleado VALUES('$cod_empleado','$nombre1_empleado','$nombre2_empleado','$apellido1_empleado','$apellido2_empleado','$documento_empleado','$rol_empleado','$ciudad_empleado','$telefono_empleado','$correo_empleado','$fecha_inicio_empleado','$tipo_documento_empleado','$pais_empleado','$departamento_empleado','$jornada_empleado','$name_empleado','$horario_inicio_empleado','$horario_finalizacion_empleado','$estado_empleado')";
