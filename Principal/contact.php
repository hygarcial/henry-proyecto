...
<?php 
    ...
    $sql="SELECT * FROM crudinmobiliaria.contacto";
			   		...
			   		<div class="container-fluid">
			   			<div class="row">
			   				...
			   				<div class="slider-text-inner">
		   						<h2 class="heading-title">CContactanos</h2>
		   						<p class="fh5co-lead">Estamos para ti las 24/7, en cualquier momento uno de nuestros asesores responda tus inquietudes</p>
			   				</div>
			   			</div>
				   		</div>
			   		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>Para nosotros es un placer atenderte, solo llena algunos datos para poder contactarte.</p>
					</div>
				</div>
				<form role="form" action="contacto/insertar_contacto.php" method="POST" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							<h3 class="section-title">Puedes Encontrarnos en:</h3>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Calle 5 # 4-23 barrio cañaveral</li>
								<li><i class="icon-phone2"></i>+57 318 4354004</li>
								<li><i class="icon-mail"></i><a href="#">homestate@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.homestate.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
