			   		...
			   		<div class="container-fluid">
			   			<div class="row">
			   				...
			   				<div class="slider-text-inner">
		   						...
		   						<p class="fh5co-lead">Tenemos los mejores empleados especializados en las areas inmobiliarias</p>
			   				</div>
			   			</div>
				   		</div>
			   		</div>
				...
				<div class="row">
					...
					<div class="col-sm-4 text-center animate-box" data-animate-effect="fadeIn">
						<div class="fh5co-staff">
							<img class="img-responsive" src="http://localhost/henry-proyecto/Empleado/image_empleado/<?= $row['foto_empleado'];?>" alt="Free HTML5 Templates by freeHTML5.co">
							<h3><?php echo $row['nombre1_empleado']." ".$row['nombre2_empleado']." ".$row['apellido1_empleado']." ".$row['apellido2_empleado'] ?></h3>
							<span class="list-prop"><?php echo $row['rol_empleado'] ?></span>
							<p><?php echo $row['horario_inicio_empleado']." Hasta ".$row['horario_finalizacion_empleado'] ?></p>
							...
							<p><a class="btn btn-primary btn-outline" href="#">Ver Detalles</a></p>
						</div>
					</div>
					<?php 
					}
